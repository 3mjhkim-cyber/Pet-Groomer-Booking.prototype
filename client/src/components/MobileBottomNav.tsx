...
import { LayoutDashboard, Users, CalendarDays, TrendingUp, Wrench } from "lucide-react";
...
const shopOwnerNavItems = [
  ...
  { href: "/admin/operations", label: "운영",     icon: Wrench },
];
    ...
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-border safe-area-bottom">
      <div className="grid grid-cols-5 h-16">
        {shopOwnerNavItems.map((item) => {
          // operations 항목은 /admin/operations 로 시작하면 활성
          const isActive = item.href === "/admin/operations"
