      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm px-6 sm:px-10 py-10 space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="rounded-xl bg-gray-50 border border-gray-200 px-6 py-6 space-y-4">
              <div className="flex items-start gap-3">
                <span className="text-gray-400 mt-0.5 text-lg">📧</span>
                <div>
                  <p className="font-medium text-gray-800 text-sm">이메일 문의</p>
                  <p className="text-gray-600 text-sm">support@jeongrihagae.com</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gray-400 mt-0.5 text-lg">🕐</span>
                <div>
                  <p className="font-medium text-gray-800 text-sm">운영시간</p>
                  <p className="text-gray-600 text-sm">평일 10:00 ~ 18:00</p>
          ...
          <section>
            ...
            <p className="mb-4 text-gray-600 text-sm">아래 항목에 해당하는 문의를 이메일로 보내주시면 순서대로 답변드립니다.</p>
          ...
          <section>
            ...
            <ul className="space-y-2 pl-4 list-disc list-outside text-gray-600">
              <li>이메일 문의는 운영시간 기준으로 순차 처리되며, 통상 <span className="font-medium text-gray-800">1~2 영업일 이내</span> 답변드립니다.</li>
